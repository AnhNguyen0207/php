...
!function (e, t) {
    ...
    var e, r, U = (function (e) {
        ...
        "undefined" != typeof window && (n = (t = window).HTMLCanvasElement && t.HTMLCanvasElement.prototype, l = t.Blob && function () {
            ...
            return l ? new Blob([s ? n : a], {type: t}) : ((o = new c).append(a), o.getBlob(t))
        ...
        path: e, exports: {}, require: function (e, t) {
            return function () {
                throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")
            }(null == t && r.path)
        }
    }, r.exports), r.exports), o = {
        strict: !0,
        checkOrientation: !0,
        maxWidth: 1 / 0,
        maxHeight: 1 / 0,
        ...
        success: null,
        error: null
    }, s = "undefined" != typeof window && void 0 !== window.document ? window : {}, c = Array.prototype.slice;
    var a = /^image\/.+$/;
    ...
    function f(e) {
        ...
        try {
            if (255 === l.getUint8(0) && 216 === l.getUint8(1)) for (var s = l.byteLength, c = 2; c + 1 < s;) {
            ...
            if (r && (n = r + 10, "Exif" === function (e, t, r) {
                ...
                return n
            }(l, r + 4, 4) && (!(o = 18761 === (i = l.getUint16(n))) && 19789 !== i || 42 !== l.getUint16(n + 2, o) || 8 <= (i = l.getUint32(n + 4, o)) && (a = n + i))), a) for (var u, h = l.getUint16(a, o), f = 0; f < h; f += 1) if (u = a + 12 * f + 2, 274 === l.getUint16(u, o)) {
    ...
    var b = s.ArrayBuffer, p = s.FileReader, g = s.URL || s.webkitURL, y = /\.\w+$/, w = s.Compressor;
    return function () {
        function r(e, t) {
            !function (e, t) {
        ...
        return e = r, a = [{
            ...
            key: "init", value: function () {
                var a, e, n, i = this, o = this.file, t = this.options;
                e = o, "undefined" != typeof Blob && (e instanceof Blob || "[object Blob]" === Object.prototype.toString.call(e)) ? B(a = o.type) ? g && p ? (b || (t.checkOrientation = !1), g && !t.checkOrientation ? this.load({url: g.createObjectURL(o)}) : (e = new p, n = t.checkOrientation && "image/jpeg" === a, (this.reader = e).onload = function (e) {
                    var t = e.target.result, r = {};
                    n ? 1 < (e = f(t)) || !g ? (r.url = h(t, a), 1 < e && l(r, function (e) {
                        ...
                        return {rotate: t, scaleX: r, scaleY: a}
            ...
            key: "load", value: function (e) {
                var t = this, r = this.file, a = this.image;
                a.onload = function () {
                    t.draw(i(i({}, e), {}, {naturalWidth: a.naturalWidth, naturalHeight: a.naturalHeight}))
                }, a.onabort = function () {
            ...
            key: "draw", value: function (e) {
                var t = this, r = e.naturalWidth, a = e.naturalHeight, n = e.rotate, i = void 0 === n ? 0 : n,
                    o = e.scaleX, l = void 0 === o ? 1 : o, s = e.scaleY, c = void 0 === s ? 1 : s, u = this.file,
                    h = this.image, f = this.options, d = document.createElement("canvas"), m = d.getContext("2d"),
                    b = r / a, p = Math.abs(i) % 180 == 90, g = Math.max(f.maxWidth, 0) || 1 / 0,
                    y = Math.max(f.maxHeight, 0) || 1 / 0, w = Math.max(f.minWidth, 0) || 0,
                    n = Math.max(f.minHeight, 0) || 0, o = Math.max(f.width, 0) || r, e = Math.max(f.height, 0) || a;
                ...
                u.size > f.convertSize && "image/png" === f.mimeType && (v = "#fff", f.mimeType = "image/jpeg"), m.fillStyle = v, m.fillRect(0, 0, o, e), f.beforeDraw && f.beforeDraw.call(this, m, d), this.aborted || (m.save(), m.translate(o / 2, e / 2), m.rotate(i * Math.PI / 180), m.scale(l, c), m.drawImage(h, w, g, n, y), m.restore(), f.drew && f.drew.call(this, m, d), this.aborted || (m = function (e) {
                    t.aborted || t.done({naturalWidth: r, naturalHeight: a, result: e})
                }, d.toBlob ? d.toBlob(m, f.mimeType, f.quality) : m(U(d.toDataURL(f.mimeType, f.quality)))))
            }
        }, {
            key: "done", value: function (e) {
                var t = e.naturalWidth, r = e.naturalHeight, a = e.result, n = this.file, i = this.image,
                    e = this.options;
